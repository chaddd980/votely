...
class PollDetails extends Component {
  ...
  handleDelete(e){
    ...
    let self = this
    axios.post('http://vote-chaddly.herokuapp.com/polls/delete', question).then(function(res){
  ...
  handleSubmit(e){
    ...
    let self = this
    axios.post("http://vote-chaddly-server.herokuapp.com/polls/" + question, option)
  }
